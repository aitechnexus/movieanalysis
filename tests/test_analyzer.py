...
class TestMovieAnalyzer:
    ...
    def test_init(self, sample_movies_data: pd.DataFrame, sample_ratings_data: pd.DataFrame):
    ...
    def test_get_user_preferences(self, movie_analyzer: MovieAnalyzer):
        ...
        expected_keys = ['favorite_genres', 'avg_rating', 'total_ratings', 'rating_distribution', 'activity_level']
    ...
    def test_get_movie_recommendations(self, movie_analyzer: MovieAnalyzer):
        ...
        recommendations = movie_analyzer.get_movie_recommendations(user_id, method="popularity", limit=3)
    ...
    def test_calculate_movie_similarity(self, movie_analyzer: MovieAnalyzer):
        ...
        similar_movies = movie_analyzer.calculate_movie_similarity(movie_id, method="genre", limit=2)
    ...
    def test_get_statistics_summary(self, movie_analyzer: MovieAnalyzer):
        ...
        expected_keys = [
            'total_movies', 'total_users', 'total_ratings',
            'avg_rating', 'rating_std', 'sparsity'
        ]
    ...
    def test_top_movies_different_min_ratings(self, movie_analyzer: MovieAnalyzer, min_ratings: int):
    ...
    def test_time_based_analysis(self, movie_analyzer: MovieAnalyzer):
        ...
        movie_analyzer.ratings_df['timestamp'] = pd.to_datetime(movie_analyzer.ratings_df['timestamp'])
